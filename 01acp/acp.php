...
if($xml && $xml->_01acp->version > $settings['acpversion'] && $userdata['module'] == 1)
	$newerversion = " <a href=\"".$xml->_01acp->updateurl."\" target=\"_blank\"><b class=\"yellow\">Update verfügbar!</b></a>";
else
	$newerversion = ""; 
...
<div class="acp_doubleinnerbox">
	<p style="float:left; margin-right:15px; margin-top:17px;"><b>Was möchten Sie tun?</b></p>
	<br />
